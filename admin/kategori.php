...
<head>
    ...
    <title>Kelola Kategori - UD.ATM FAJAR</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="kategori.php">Kategori Seafood</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2">Tambah Kategori Seafood</button>
                                </div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Tambah Kategori Seafood</h4>
						</div>
