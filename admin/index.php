...
<head>
    ...
    <title>Admin Panel - UD.ATM FAJAR</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li>
                                ...
                                <ul class="collapse">
                                    <li><a href="kategori.php">Kategori Seafood</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
									...
									<br>
									<p>Pada halaman admin, Anda dapat menambah kategori produk seafood, mengelola produk seafood, 
